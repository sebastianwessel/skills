...
- Enforces spec conformance, interface correctness, test coverage, security, performance, robustness, maintainability, and public API/documentation quality.
...
3. Review spec conformance, interfaces, tests, security, performance, robustness, maintainability, and docs.
