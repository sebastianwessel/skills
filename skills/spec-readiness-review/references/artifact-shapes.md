...
`semantic_alignment_gate`, `requirements_quality_gate`, `concise_spec_gate`,
...
`migration_gate`, `contradiction_check`, `spec_judge_loop`,
...
evidence, clean-rebuild evidence, HITL decisions, and maintenance impact.
